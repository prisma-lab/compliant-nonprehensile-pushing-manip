...
#else
  #define CASADI_PREFIX(ID) pushing_reduced_expl_vde_forw_ ## ID
#endif
...
/* pushing_reduced_expl_vde_forw:(i0[8],i1[8x8],i2[8x5],i3[5],i4[10])->(o0[8],o1[8x8],o2[8x5]) */
...
CASADI_SYMBOL_EXPORT int pushing_reduced_expl_vde_forw(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, void* mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT void pushing_reduced_expl_vde_forw_incref(void) {
}

CASADI_SYMBOL_EXPORT void pushing_reduced_expl_vde_forw_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int pushing_reduced_expl_vde_forw_n_in(void) { return 5;}

CASADI_SYMBOL_EXPORT casadi_int pushing_reduced_expl_vde_forw_n_out(void) { return 3;}

CASADI_SYMBOL_EXPORT const char* pushing_reduced_expl_vde_forw_name_in(casadi_int i){
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* pushing_reduced_expl_vde_forw_name_out(casadi_int i){
  switch (i) {
    case 0: return "o0";
    case 1: return "o1";
    case 2: return "o2";
...
CASADI_SYMBOL_EXPORT const casadi_int* pushing_reduced_expl_vde_forw_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* pushing_reduced_expl_vde_forw_sparsity_out(casadi_int i) {
  switch (i) {
    case 0: return casadi_s0;
    case 1: return casadi_s1;
    case 2: return casadi_s2;
...
CASADI_SYMBOL_EXPORT int pushing_reduced_expl_vde_forw_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 5;
  if (sz_res) *sz_res = 3;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
